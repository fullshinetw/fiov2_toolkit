...
When I want to know the storage like DAS or NAS performance benchmark, engineering have tool like IOmeter, fio, sysbench, hdparm etc. 
...
But the IOmeter(UI)/dynamo(cli) was a long time no maintain. As we know the **fio** have a lot of parameters help for custimize test case.
So, I try to define the benchmark parameters like IOmeter's configuration and create fiov2_toolkit.
